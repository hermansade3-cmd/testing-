...
<div style="display:flex;border-radius:18px;overflow:hidden;background:#0b3d91;color:white;box-shadow:0 6px 25px rgba(0,0,0,0.35);animation-delay:${delay}s">    <!-- Cover -->    
